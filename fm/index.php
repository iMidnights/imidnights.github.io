...
//Application Title
define('APP_TITLE', 'iMidnight | FileManager');
...
$favicon_path = 'http://home.imidnight.ml/assets/images/logo/favicon.png';
            ...
            <div class="container-fluid h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div style="background-color: #001e2d; border-radius: 10pt;" class="card fat">
                            <div style="background-color: #001e2d; border-radius: 10pt; border: 5px solid #001e2d; " class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand animated pulse infinite">
                                            <img src="http://home.imidnight.ml/assets/images/logo/logo.png">
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#f7f9fb;font-size:14px;background-color:#f7f9fb;background-image:url("http://home.imidnight.ml/assets/images/storage/BG2.png");}
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="iMidnight File Manager">
    <meta name="author" content="CCP Programmers">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo fm_enc($favicon_path) ?>" type="image/png">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'iMidnight';              $tr['en']['AppTitle']           = 'iMidnight';
