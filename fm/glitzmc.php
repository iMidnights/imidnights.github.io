...
//Application Title
define('APP_TITLE', 'GlitzMC | FileManagerF');
...
$auth_users = array(
    'iMidnight' => '$2y$10$pxPYZEYGyj.5D1szTBuJIeuk4PcWpM/NiDGLq.Y8RV5WCrQdFa3nq', //Mohamed159
);
...
$favicon_path = 'https://glitzmc.uk/assets/favicon.png';
...
<nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <img class="navbar-brand" src="https://glitzmc.uk/index_files/logo.png" width="50"><a class="navbar-brand" href="#">GlitzMC</a>
...
<br>
<br>
        <section class="h-100 animated FadeInDown">
            <style>
                * {
                    color: antiquewhite;
                }
            ...
            <div class="container-fluid h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div style="background-color: rgba(0, 30, 45, 0.8); border-radius: 10pt;" class="card fat">
                            <div style="background-color: rgba(0, 30, 45, 0.8); border-radius: 10pt; border: 5px solid rgba(0, 30, 45, 0.8); " class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand animated pulse infinite">
                                            <img src="https://glitzmc.uk/index_files/logo.png">
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                                        <label for="fm_usr"><?php echo lng('Username'); ?></label>
                                        <input type="text" class="form-contro" id="fm_usr full-name" name="fm_usr" required autofocus>
                                    </div>

                                    <div class="form-group">
                                        <label for="fm_pwd"><?php echo lng('Password'); ?></label>
                                        <input type="password" class="form-contro" id="fm_pwd email-address" name="fm_pwd" required>
                                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p>
                        <button type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i> <?php echo lng('Copy') ?></button> &nbsp;
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary"> <i class="fa fa-check-circle"></i> <?php echo lng('Save'); ?></button>
                        </div>
                    </div>
                ...
                <div class="row js-new-pwd hidden mt-2">
                    <div class="col-12">
                        <form class="form-inline" onsubmit="return new_password_hash(this)" method="POST" action="">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm mb-2"><?php echo lng('Generate') ?></button>
                        </form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'GlitzMC<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <link rel="stylesheet" href="https://glitzmc.uk/assets/animate.css">
    <link rel="stylesheet" href="https://glitzmc.uk/core/aos.css">
    <link rel="stylesheet" href="https://glitzmc.uk/core/style.css">
    <script src="https://glitzmc.uk/core/fontawesome/js/all.js"></script>
...
body {
   color: white;
    ...
    <style>
        body.fm-login-page{ background-color:#f7f9fb;font-size:14px;background-color:#f7f9fb;background-image:url("https://glitzmc.uk/images/background.jpg");}
...
<body class="fm-login-page animated fadeIn">
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="GlitzMC File Manager">
    <meta name="author" content="CCP Programmers">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo fm_enc($favicon_path) ?>" type="image/png">
...
<body class="<?php echo $isStickyNavBar; ?> animated fadeIn">
<div id="wrapper" class="container-fluid">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'GlitzMC';                $tr['en']['AppTitle']           = 'GlitzMC';
