...
<html style="align-items: center;">
    <head>
		<link rel="icon" href="https://imidnight.ga/tic-tac-toe/favicon.png">
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<meta http-equiv="x-ua-compatible" content="ie=edge">
		<link rel="icon" href="https://imidnight.ml/assets/logo.png" type="image/x-icon">
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css">
		<!-- Google Fonts Roboto -->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap">
		<!-- Bootstrap core CSS -->
		<link rel="stylesheet" href="https://imidnight.ml/css/bootstrap.min.css">
		<!-- Material Design Bootstrap -->
		<link rel="stylesheet" href="https://imidnight.ml/css/mdb.min.css">
		<!-- Your custom styles (optional) -->
		<link rel="stylesheet" href="https://imidnight.ml/css/style.css">
		<!-- Popup -->
		<link rel="stylesheet" href="https://imidnight.ml/popup.css">
...
<script>
  ...
  gtag('config', 'UA-163704754-1');
    ...
    <body style="text-align: center; font-family: 'Bahnschrift'; background-image: url("https://imidnight.ml/assets/discord.png"); display: flex; align-items: center;">
        ...
        <div style="-moz-user-select: none; -webkit-user-select:none; -ms-user-select:none; user-select:none; -moz-user-drag:none; -webkit-user-drag:none; -ms-user-drag:none; user-drag: none;" unselectable="on">
            <p style="padding-top: 32pt;">Welcome to Tic-Tac-Toe.</p><a class="btn btn-primary" href="https://imidnight.ml">Back to home</a>
            <?php
...
class Game {
    ...
    function generate_win_lines() {
        ...
        if ($this->debug) {
            // Create Table
            echo '<br /><table border = "1" style="border-collapse: collapse" class="btn btn-primary">';
            // Table Header
            ...
            foreach ($this->win_lines as $line_type) {
                echo '<td><div style="padding:8px; align-items: center;" class="btn btn-primary">';
